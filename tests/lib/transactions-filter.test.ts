...
function tx(p: Partial<TxnView>): TxnView {
  return { id: "t", date: "2026-07-05", amount: -10, label: "", accountId: "a1", accountLabel: "A1", groupId: null, lineId: null, excluded: false, ignored: false, manual: false, incomeKind: null, note: null, ...p };
}
